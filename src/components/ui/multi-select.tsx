        ...
        >
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                "flex p-1 rounded-md  min-h-10 h-auto items-center justify-between bg-inherit border border-gray-300 hover:bg-inherit [&_svg]:pointer-events-auto",
                ...
                <div className="flex items-center justify-between w-full">
                  ...
                  <div className="flex items-center justify-between">
                    <div
                      ...
                      className="flex items-center justify-center w-4 h-4 mx-2 rounded-sm cursor-pointer text-muted-foreground hover:text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-1"
                    >
